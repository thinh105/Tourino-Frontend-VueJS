<template>
  <v-card flat class="TrnAuthCard">
    <v-tabs
      class="rounded-tr-xl"
      background-color="#003C71CC"
      color="secondary"
      center
      grow
      dark
...
<script>
  import TrnLogin from './Login.vue';
  import TrnSignUp from './Signup.vue';
  import TrnForgetPass from './ForgetPass.vue';
